...
const EN: PricingContent = {
  labels: {
    ...
    multimodalBenefit: 'Open Design Cloud models: power agents, generate images & video',
...
const ZH_CN: PricingContent = {
  labels: {
    ...
    multimodalBenefit: 'Open Design 云端模型：驱动 Agent、生成图片与视频',
...
const ZH_TW: PricingContent = {
  labels: {
    ...
    multimodalBenefit: 'Open Design 雲端模型：驅動 Agent、生成圖片與影片',
...
const ES: PricingContent = {
  labels: {
    ...
    multimodalBenefit: 'Modelos de Open Design Cloud: agentes, imágenes y vídeo',
...
const PT_BR: PricingContent = {
  labels: {
    ...
    multimodalBenefit: 'Modelos do Open Design Cloud: agentes, imagens e vídeo',
...
const RU: PricingContent = {
  labels: {
    ...
    multimodalBenefit: 'Модели Open Design Cloud: агенты, изображения и видео',
...
const FR: PricingContent = {
  labels: {
    ...
    multimodalBenefit: 'Modèles Open Design Cloud : agents, images et vidéos',
...
const KO: PricingContent = {
  labels: {
    ...
    multimodalBenefit: 'Open Design Cloud 모델: Agent 구동, 이미지 및 동영상 생성',
...
const DE: PricingContent = {
  labels: {
    ...
    multimodalBenefit: 'Open Design Cloud-Modelle: Agenten, Bilder und Videos',
...
const JA: PricingContent = {
  labels: {
    ...
    multimodalBenefit: 'Open Design Cloud モデル：Agent 駆動・画像・動画生成',
