...
const EN: TeamPricingContent = {
  ...
  teamTitle: 'Team',
  teamTagline: 'Includes all Creator features, plus team collaboration',
  recommended: 'Recommended',
  creditLabel: 'Model credits per seat',
  seatOnly: 'Seats only, no model credits',
  creditUnit: 'model credits',
  seats: 'Seats (minimum {count})',
  decreaseSeats: 'Decrease seats',
  increaseSeats: 'Increase seats',
  perSeatMonth: '/ seat / month',
  monthlyTotal: 'First month {amount} (save {savings})',
  yearlyTotal: 'First year {amount} (save {savings})',
...
const ZH: TeamPricingContent = {
  ...
  teamTitle: '团队版',
  teamTagline: '包含创作会员全部功能，额外提供团队协作',
  recommended: '推荐',
  creditLabel: '每席模型额度',
  seatOnly: '仅席位，不含模型额度',
  creditUnit: '模型额度',
  seats: '席位数（至少 {count} 席）',
  decreaseSeats: '减少席位',
  increaseSeats: '增加席位',
  perSeatMonth: '/ 席 / 月',
  monthlyTotal: '首月仅需 {amount}（省 {savings}）',
  yearlyTotal: '首年仅需 {amount}（省 {savings}）',
  checkout: '升级团队版',
  teamFeatures: [
    '团队共享项目、设计系统与插件',
    '成员查看与评论，项目创建者编辑',
    'Owner / Admin / Member 权限管理',
  ],
  enterpriseTitle: '企业版',
...
const JA: TeamPricingContent = {
  ...
  perSeatMonth: '/ 席 / 月',
  monthlyTotal: '初月は {amount}（{savings} 節約）',
  yearlyTotal: '初年度は {amount}（{savings} 節約）',
...
const KO: TeamPricingContent = {
  ...
  recommended: '추천',
  creditLabel: '좌석당 모델 크레딧',
  seatOnly: '좌석만 제공, 모델 크레딧 없음',
  creditUnit: '모델 크레딧',
  seats: '좌석 수 (최소 {count}개)',
  decreaseSeats: '좌석 줄이기',
  increaseSeats: '좌석 늘리기',
  perSeatMonth: '/ 좌석 / 월',
  monthlyTotal: '첫 달 {amount} ({savings} 절약)',
  yearlyTotal: '첫해 {amount} ({savings} 절약)',
...
const DE: TeamPricingContent = {
  ...
  creditLabel: 'Modellguthaben pro Sitz',
  seatOnly: 'Nur Sitze, kein Modellguthaben',
  creditUnit: 'Modellguthaben',
  seats: 'Sitze (mindestens {count})',
  decreaseSeats: 'Sitz entfernen',
  increaseSeats: 'Sitz hinzufügen',
  perSeatMonth: '/ Sitz / Monat',
  monthlyTotal: 'Im ersten Monat {amount} ({savings} sparen)',
  yearlyTotal: 'Im ersten Jahr {amount} ({savings} sparen)',
...
const FR: TeamPricingContent = {
  ...
  creditLabel: 'Crédits modèles par siège',
  seatOnly: 'Sièges uniquement, sans crédits modèles',
  creditUnit: 'crédits modèles',
  seats: 'Sièges ({count} minimum)',
  decreaseSeats: 'Retirer un siège',
  increaseSeats: 'Ajouter un siège',
  perSeatMonth: '/ siège / mois',
  monthlyTotal: 'Premier mois à {amount} (économisez {savings})',
  yearlyTotal: 'Première année à {amount} (économisez {savings})',
...
const ES: TeamPricingContent = {
  ...
  creditLabel: 'Créditos de modelos por asiento',
  seatOnly: 'Solo asientos, sin créditos de modelos',
  creditUnit: 'créditos de modelos',
  seats: 'Asientos (mínimo {count})',
  decreaseSeats: 'Quitar un asiento',
  increaseSeats: 'Añadir un asiento',
  perSeatMonth: '/ asiento / mes',
  monthlyTotal: 'Primer mes por {amount} (ahorra {savings})',
  yearlyTotal: 'Primer año por {amount} (ahorra {savings})',
...
const PT_BR: TeamPricingContent = {
  ...
  recommended: 'Recomendado',
  creditLabel: 'Créditos de modelo por assento',
  seatOnly: 'Apenas assentos, sem créditos de modelos',
  creditUnit: 'créditos de modelos',
  seats: 'Assentos (mínimo de {count})',
  decreaseSeats: 'Diminuir assentos',
  increaseSeats: 'Aumentar assentos',
  perSeatMonth: '/ assento / mês',
  monthlyTotal: 'Primeiro mês por {amount} (economize {savings})',
  yearlyTotal: 'Primeiro ano por {amount} (economize {savings})',
...
const IT: TeamPricingContent = {
  ...
  creditLabel: 'Crediti modello per postazione',
  seatOnly: 'Solo postazioni, senza crediti modello',
  creditUnit: 'crediti modello',
  seats: 'Postazioni (minimo {count})',
  decreaseSeats: 'Riduci le postazioni',
  increaseSeats: 'Aumenta le postazioni',
  perSeatMonth: '/ postazione / mese',
  monthlyTotal: 'Primo mese a {amount} (risparmia {savings})',
  yearlyTotal: 'Primo anno a {amount} (risparmia {savings})',
