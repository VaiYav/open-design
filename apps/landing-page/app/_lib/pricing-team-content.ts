...
const EN: TeamPricingContent = {
  ...
  teamTitle: 'Team',
  teamTagline: 'Complete creator capabilities, plus team collaboration',
  creatorBenefitsNote:
    'Every seat includes all Creator feature benefits; model credits are configured by the selected Team tier.',
  recommended: 'Recommended',
  creditLabel: 'Choose monthly model credits per seat',
...
const ZH: TeamPricingContent = {
  ...
  teamTitle: '团队版',
  teamTagline: '完整创作能力，加上团队协作',
  creatorBenefitsNote:
    '每个席位均包含创作会员的全部功能权益；模型额度按所选团队档位配置。',
  recommended: '推荐',
  creditLabel: '选择每席每月模型额度',
  seatOnly: '仅席位，不含模型额度',
  creditUnit: '模型额度',
  seats: '席位数',
  decreaseSeats: '减少席位',
...
const JA: TeamPricingContent = {
  ...
  teamTitle: 'Team',
  teamTagline: 'クリエイターの全機能に、チームコラボレーションを追加',
  creatorBenefitsNote:
    '各席にはクリエイタープランのすべての機能特典が含まれ、モデルクレジットは選択した Team ティアに応じて設定されます。',
  recommended: 'おすすめ',
  creditLabel: '1 席あたりの月間モデルクレジットを選択',
...
const KO: TeamPricingContent = {
  ...
  teamTitle: 'Team',
  teamTagline: '크리에이터의 모든 기능에 팀 협업을 더했습니다',
  creatorBenefitsNote:
    '모든 좌석에 크리에이터 멤버십의 전체 기능 혜택이 포함되며, 모델 크레딧은 선택한 Team 등급에 따라 구성됩니다.',
  recommended: '추천',
  creditLabel: '좌석당 월간 모델 크레딧 선택',
...
const DE: TeamPricingContent = {
  ...
  teamTitle: 'Team',
  teamTagline: 'Alle Creator-Funktionen plus Team-Zusammenarbeit',
  creatorBenefitsNote:
    'Jeder Sitz enthält alle funktionalen Vorteile der Creator-Mitgliedschaft; das Modellguthaben richtet sich nach der gewählten Team-Stufe.',
  recommended: 'Empfohlen',
  creditLabel: 'Monatliches Modellguthaben pro Sitz wählen',
...
const FR: TeamPricingContent = {
  ...
  teamTitle: 'Équipe',
  teamTagline: 'Toutes les fonctionnalités Creator, plus la collaboration en équipe',
  creatorBenefitsNote:
    'Chaque siège inclut tous les avantages fonctionnels de l’abonnement Creator ; les crédits modèles dépendent du niveau Team sélectionné.',
  recommended: 'Recommandé',
  creditLabel: 'Choisir les crédits modèles mensuels par siège',
...
const RU: TeamPricingContent = {
  ...
  teamTitle: 'Команда',
  teamTagline: 'Все функции Creator плюс командная работа',
  creatorBenefitsNote:
    'Каждое место включает все функциональные преимущества подписки Creator; кредиты моделей зависят от выбранного уровня Team.',
  recommended: 'Рекомендуем',
  creditLabel: 'Выберите ежемесячные кредиты моделей на место',
...
const ES: TeamPricingContent = {
  ...
  teamTitle: 'Equipo',
  teamTagline: 'Todas las funciones de Creator, más colaboración en equipo',
  creatorBenefitsNote:
    'Cada asiento incluye todas las ventajas funcionales de la membresía Creator; los créditos de modelos dependen del nivel Team seleccionado.',
  recommended: 'Recomendado',
  creditLabel: 'Elige los créditos de modelos al mes por asiento',
...
const PT_BR: TeamPricingContent = {
  ...
  teamTitle: 'Equipe',
  teamTagline: 'Todos os recursos do Creator, mais colaboração em equipe',
  creatorBenefitsNote:
    'Cada assento inclui todos os benefícios funcionais da assinatura Creator; os créditos de modelo dependem do nível Team selecionado.',
  recommended: 'Recomendado',
  creditLabel: 'Escolha os créditos de modelos mensais por assento',
...
const IT: TeamPricingContent = {
  ...
  teamTitle: 'Team',
  teamTagline: 'Tutte le funzionalità Creator, più la collaborazione in team',
  creatorBenefitsNote:
    'Ogni postazione include tutti i vantaggi funzionali dell’abbonamento Creator; i crediti modello dipendono dal livello Team selezionato.',
  recommended: 'Consigliato',
  creditLabel: 'Scegli i crediti modello mensili per postazione',
...
const TR: TeamPricingContent = {
  ...
  teamTitle: 'Ekip',
  teamTagline: 'Tüm Creator özellikleri ve ekip iş birliği',
  creatorBenefitsNote:
    'Her koltuk Creator üyeliğinin tüm işlevsel avantajlarını içerir; model kredileri seçilen Team kademesine göre yapılandırılır.',
  recommended: 'Önerilen',
  creditLabel: 'Koltuk başına aylık model kredisini seçin',
